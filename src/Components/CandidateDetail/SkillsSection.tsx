...
const SkillsSection = () => {
    ...
    const hasSkills = candidateById?.skills && candidateById.skills.length > 0;
    const hasTools = candidateById?.tools && candidateById.tools.length > 0;
    const hasMethodology = candidateById?.methodology && candidateById.methodology.length > 0;
